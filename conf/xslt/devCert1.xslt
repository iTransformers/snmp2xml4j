    ...
    <xsl:template match="/">
        ...
        <root>
            <xsl:variable name="objectNames"
                          select="distinct-values(//.[@snmpSyntax='Counter' or @snmpSyntax='Gauge' or @snmpSyntax='Counter32'or @snmpSyntax='Counter64' or @snmpSyntax='Gauge32' or @snmpSyntax='Gauge64']/../name())"/>
            ...
            <objects>
                <xsl:for-each select="$objectNames">
                    ...
                    <object><xsl:attribute name="name" select="$objectName"/>
                        ...
                        <indicators>
                            <xsl:variable name="performanceIndicators" select="distinct-values($root//.[name()=$objectName]//.[name()!='index' and name()!='instance' and name()!='' and (@snmpSyntax='Counter' or @snmpSyntax='Gauge' or @snmpSyntax='Counter32'or @snmpSyntax='Counter64' or @snmpSyntax='Gauge32' or @snmpSyntax='Gauge64') ]/name())"/>
                        ...
                        <otherOids>
                        <xsl:variable name="otherOids" select="distinct-values($root//.[name()=$objectName]//.[name()!='index' and name()!='instance' and name()!='' and ( @snmpSyntax!='Counter' and @snmpSyntax!='Gauge'and @snmpSyntax!='Counter32'and @snmpSyntax!='Counter64' and @snmpSyntax!='Gauge32' and @snmpSyntax!='Gauge64' and @snmpSyntax!='SEQUENCE') ]/name())"/>
