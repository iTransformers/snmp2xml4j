#!/bin/sh
if [ -z ${SNMP2XML4J+x} ]; then echo "SNMP2XML4J project home variable is unset"; else echo "SNMP2XML4J is set to '$SNMP2XML4J'"; exit; fi
...
java -classpath ${CLASSPATH} net.itransformers.snmp2xml4j.snmptoolkit.Get $*
