...
//
//        snmpManager = new SnmpUdpV3Manager(TestResources.getMibLoaderHolder().getLoader(), "193.19.175.150", SecurityLevel.AUTH_PRIV, "usr-sha-aes", "authkey1", "SHA", "AES", "privkey1", 3, 1000, 65535, 10,161);
//        snmpManager.init();
//
//    }
//
