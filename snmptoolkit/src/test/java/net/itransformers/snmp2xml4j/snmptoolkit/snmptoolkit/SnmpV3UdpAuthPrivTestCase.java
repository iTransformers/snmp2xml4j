...
public class SnmpV3UdpAuthPrivTestCase {
    ...
    public static   void prepareSettings() throws IOException, MibLoaderException {
        ...
        snmpManager = new SnmpUdpV3Manager(TestResources.getMibLoaderHolder().getLoader(), "195.218.195.228", SecurityLevel.AUTH_PRIV, "usr-sha-aes", "authkey1", "SHA", "AES", "privkey1", 2, 1000, 65535, 10,161);
        snmpManager.init();
